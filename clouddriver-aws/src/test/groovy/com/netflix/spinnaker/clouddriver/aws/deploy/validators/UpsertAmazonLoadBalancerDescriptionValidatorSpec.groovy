...
class UpsertAmazonLoadBalancerDescriptionValidatorSpec extends Specification {
  ...
  void setup() {
    description = new UpsertAmazonLoadBalancerDescription(credentials:
            new NetflixAmazonCredentials('test', 'test', 'test', '12345', 'kp', [new AmazonCredentials.AWSRegion("us-west-1", ["us-west-1a"])], null, null, null, null, null, null, null, null, null, null))
  }
