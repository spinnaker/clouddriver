...
class UpsertAmazonLoadBalancerV2AtomicOperationSpec extends Specification {
      ...
      new UpsertAmazonLoadBalancerV2Description.Listener(
        ...
        defaultActions: [
          new UpsertAmazonLoadBalancerV2Description.Action(
            targetGroupName: "target-group-foo"
          )
        ]
      )
    ],
  ...
  def targetGroup = new TargetGroup(targetGroupArn: targetGroupArn, targetGroupName: "target-group-foo", port: 80, protocol: ProtocolEnum.HTTP)
