...
public class NetflixAssumeRoleAmazonCredentials extends NetflixAmazonCredentials {
    ...
    public NetflixAssumeRoleAmazonCredentials(@JsonProperty("name") String name,
        ...
        this(name, environment, accountType, accountId, defaultKeyPair, regions, defaultSecurityGroups, requiredGroupMembership, lifecycleHooks, maxSecurityGroupsPerInstance, null, edda, eddaEnabled, discovery, discoveryEnabled, front50, front50Enabled, bastionHost, bastionEnabled, assumeRole, sessionName);
    }
