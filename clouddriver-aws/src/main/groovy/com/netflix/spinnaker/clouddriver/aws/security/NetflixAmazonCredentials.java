...
public class NetflixAmazonCredentials extends AmazonCredentials {
    ...
    public NetflixAmazonCredentials(@JsonProperty("name") String name,
        ...
        this(name, environment, accountType, accountId, defaultKeyPair, regions, defaultSecurityGroups, requiredGroupMembership, lifecycleHooks, maxSecurityGroupsPerInstance, null, edda, eddaEnabled, discovery, discoveryEnabled, front50, front50Enabled, bastionHost, bastionEnabled);
    }
    ...
    NetflixAmazonCredentials(String name,
                             ...
                             Integer maxSecurityGroupsPerInstance,
        ...
        super(name, environment, accountType, accountId, defaultKeyPair, regions, defaultSecurityGroups, requiredGroupMembership, lifecycleHooks, maxSecurityGroupsPerInstance, credentialsProvider);
        this.edda = edda;
