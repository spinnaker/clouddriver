...
public class NetflixAmazonCredentials extends AmazonCredentials {
    ...
    public NetflixAmazonCredentials(@JsonProperty("name") String name,
        ...
        this(name, environment, accountType, accountId, defaultKeyPair, regions, proxy, requiredGroupMembership, null, edda, eddaEnabled, discovery, discoveryEnabled, front50, front50Enabled, bastionHost, bastionEnabled);
    }
    ...
    NetflixAmazonCredentials(String name,
        ...
        super(name, environment, accountType, accountId, defaultKeyPair, regions, proxy, requiredGroupMembership, credentialsProvider);
