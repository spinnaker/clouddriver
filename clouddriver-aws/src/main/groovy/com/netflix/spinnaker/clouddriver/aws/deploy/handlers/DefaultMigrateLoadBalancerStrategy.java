...
public class DefaultMigrateLoadBalancerStrategy implements MigrateLoadBalancerStrategy {
  ...
  @Override
  public MigrateSecurityGroupStrategy getMigrateSecurityGroupStrategy() {
    return migrateSecurityGroupStrategy;
  }
