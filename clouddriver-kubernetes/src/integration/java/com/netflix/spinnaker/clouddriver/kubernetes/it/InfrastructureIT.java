...
public class InfrastructureIT extends BaseTest {
  ...
  //    // ------------------------- given --------------------------
  //    System.out.println("> Using namespace " + account1Ns + ", appName: " +
  // APP_SERVER_GROUP_MGRS);
  //    KubeTestUtils.deployIfMissing(
  //        baseUrl(),
  //        ACCOUNT1_NAME,
  ...
  //        kubeCluster);
  //    KubeTestUtils.deployIfMissing(
  //        baseUrl(), ACCOUNT1_NAME, account1Ns, "service", "other", APP_LOAD_BALANCERS,
  // kubeCluster);
  //
  //    KubeTestUtils.repeatUntilTrue(
  //        () -> {
  ...
  //
  //          resp.then().statusCode(200);
  //          List<Object> list1 = resp.jsonPath().getList(ACCOUNT1_NAME + ".kubernetes." +
  // account1Ns);
  //          List<Object> list2 = resp.jsonPath().getList(ACCOUNT2_NAME + ".kubernetes." +
  // account2Ns);
  ...
  //          + "Then response should contain the security group specified in
  ...
  //  @Test
  //  public void shouldGetServerGroupManagerForApplication() throws InterruptedException,
  // IOException {
  //    // ------------------------- given --------------------------
  //    System.out.println("> Using namespace " + account1Ns + ", appName: " +
  // APP_SERVER_GROUP_MGRS);
