...
spec:
  scaleTargetRef:
    ...
    name: $name
"""
    def artifactReplacer = new ArtifactReplacer(ImmutableList.of(Replacer.HPA_DEPLOYMENT))
  ...
  template:
    ...
    spec:
      ...
      - name: container
        ...
        - containerPort: 80
"""
    def artifactReplacer = new ArtifactReplacer(ImmutableList.of(Replacer.DOCKER_IMAGE))
