...
class GoogleLabeledResourceNamerSpec extends Specification {
  ...
  def "should derive correct moniker"() {
    ...
    "cass-nccpintegration-random-junk-d0prod-z0useast1a-v003" | [(CLUSTER): "myCluster"]                  || "cass"       | "myCluster"                                          | "nccpintegration" | "random-junk"  | 3
    "cass-nccpintegration-random-junk-d0prod-z0useast1a-v003" | [(STACK): "myStack"]                      || "cass"       | null                                                 | "myStack"         | "random-junk"  | 3
    "cass-nccpintegration-random-junk-d0prod-z0useast1a-v003" | [(DETAIL): "myDetail"]                    || "cass"       | null                                                 | "nccpintegration" | "myDetail"     | 3
    "cass-nccpintegration-random-junk-d0prod-z0useast1a-v003" | [(SEQUENCE): "42"]                        || "cass"       | "cass-nccpintegration-random-junk-d0prod-z0useast1a" | "nccpintegration" | "random-junk"  | 42
    "app"                                                     | [(STACK): "myStack", (SEQUENCE): "2"]     || "app"        | null                                                 | "myStack"         | null           | 2
    ...
    "app-v042"                                                | [(DETAIL): "myDetail"]                    || "app"        | null                                                 | null              | "myDetail"     | 42
