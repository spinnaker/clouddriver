...
class TerminateDcosInstancesAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
  ...
  AtomicOperation convertOperation(Map input) {
    new TerminateDcosInstancesAtomicOperation(convertDescription(input))
  }

  @Override
  DcosInstanceDescription convertDescription(Map input) {
    DcosAtomicOperationConverterHelper.convertDescription(input, this, DcosInstanceDescription)
  }
}
