...
@Component
class DeleteDcosSecurityGroupAtomicOperationValidator extends DescriptionValidator<DeleteDcosSecurityGroupDescription>{
  @Autowired
  AccountCredentialsProvider accountCredentialsProvider

  @Override
  void validate(List priorDescriptions, DeleteDcosSecurityGroupDescription description, Errors errors) {
    def helper = new StandardDcosAttributeValidator("deleteDcosSecurityGroupDescription", errors)
