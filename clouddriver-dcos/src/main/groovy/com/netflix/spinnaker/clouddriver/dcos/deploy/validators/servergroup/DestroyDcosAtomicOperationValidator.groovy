...
@Component
class DestroyDcosAtomicOperationValidator extends DescriptionValidator<DcosServerGroupDescription> {
  @Autowired
  AccountCredentialsProvider accountCredentialsProvider

  @Override
  void validate(List priorDescriptions, DcosServerGroupDescription description, Errors errors) {
    def helper = new StandardDcosAttributeValidator("destroyDcosAtomicOperationDescription", errors)
