...
@Component
class DeleteDcosLoadBalancerAtomicOperationValidator extends DescriptionValidator<DeleteDcosLoadBalancerAtomicOperationDescription>{
  @Autowired
  ...
  void validate(List priorDescriptions, DeleteDcosLoadBalancerAtomicOperationDescription description, Errors errors) {
    def helper = new StandardDcosAttributeValidator("deleteDcosLoadBalancerAtomicOperationDescription", errors)
