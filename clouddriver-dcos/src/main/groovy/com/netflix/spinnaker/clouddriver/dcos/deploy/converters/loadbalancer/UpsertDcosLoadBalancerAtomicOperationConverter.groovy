...
class UpsertDcosLoadBalancerAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
  AtomicOperation convertOperation(Map input) {
    new UpsertDcosLoadBalancerAtomicOperation(convertDescription(input))
  }

  DcosLoadBalancerDescription convertDescription(Map input) {
    DcosAtomicOperationConverterHelper.convertDescription(input, this, DcosLoadBalancerDescription)
  }
}
