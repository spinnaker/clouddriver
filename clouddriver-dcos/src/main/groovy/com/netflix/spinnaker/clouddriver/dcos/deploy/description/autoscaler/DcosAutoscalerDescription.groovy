...
package com.netflix.spinnaker.clouddriver.dcos.deploy.description.autoscaler
...
class DcosAutoscalerDescription extends ResizeDcosAtomicOperationDescription {
  DcosScalingPolicy scalingPolicy

  DcosAutoscalerDescription() { }

  DcosAutoscalerDescription(String serverGroupName, DeployDcosAtomicOperationDescription description) {
