...
import com.netflix.spinnaker.clouddriver.dcos.security.DcosNamedAccountCredentials
...
class DcosAtomicOperationConverterHelper {
  static Object convertDescription(Map input,
    ...
    def credentials = (DcosNamedAccountCredentials) credentialsSupport.getCredentialsObject(account as String)

    def converted = (DcosAtomicOperationDescription) credentialsSupport.objectMapper
      .copy()
