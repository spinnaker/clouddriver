...
abstract class AbstractRegistrationDcosAtomicOperation implements AtomicOperation<Void> {
  ...
  AbstractRegistrationDcosAtomicOperationDescription description

  AbstractRegistrationDcosAtomicOperation(AbstractRegistrationDcosAtomicOperationDescription description) {
