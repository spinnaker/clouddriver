...
import com.netflix.spinnaker.clouddriver.dcos.deploy.ops.instance.DeregisterDcosAtomicOperation
...
@Component
class DeregisterDcosAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
  @Override
  AtomicOperation convertOperation(Map input) {
    new DeregisterDcosAtomicOperation(convertDescription(input))
  }
