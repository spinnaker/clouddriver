...
class StandardDcosAttributeValidator {
  ...
  StandardDcosAttributeValidator(String context, Errors errors) {
  ...
  def validateImagePullSecret(DcosCredentials credentials, String value, String namespace, String attribute) {
  ...
  def validateNamespace(DcosCredentials credentials, String value, String attribute) {
  ...
  def validateCredentials(String credentials, AccountCredentialsProvider accountCredentialsProvider) {
    ...
    if (result) {
      def dcosCredentials = accountCredentialsProvider.getCredentials(credentials)
      if (!(dcosCredentials?.credentials instanceof DcosCredentials)) {
