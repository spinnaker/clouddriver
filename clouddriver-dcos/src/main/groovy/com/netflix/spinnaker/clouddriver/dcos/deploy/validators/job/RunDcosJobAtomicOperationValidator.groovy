...
@Component
class RunDcosJobAtomicOperationValidator extends DescriptionValidator<RunDcosJobDescription> {
  @Autowired
  AccountCredentialsProvider accountCredentialsProvider

  @Override
  void validate(List priorDescriptions, RunDcosJobDescription description, Errors errors) {
    def helper = new StandardDcosAttributeValidator("runDcosJobAtomicOperationDescription", errors)
