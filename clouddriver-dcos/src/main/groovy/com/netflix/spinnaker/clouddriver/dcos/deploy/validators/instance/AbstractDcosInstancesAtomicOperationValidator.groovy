...
class AbstractDcosInstancesAtomicOperationValidator {
  static void validate(DcosInstanceDescription description, StandardDcosAttributeValidator helper, AccountCredentialsProvider accountCredentialsProvider) {
