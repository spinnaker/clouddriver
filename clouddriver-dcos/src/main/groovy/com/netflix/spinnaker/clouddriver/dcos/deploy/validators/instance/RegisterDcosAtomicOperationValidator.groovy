...
@Component
class RegisterDcosAtomicOperationValidator extends DescriptionValidator<AbstractRegistrationDcosAtomicOperationDescription> {
  @Autowired
  ...
  void validate(List priorDescriptions, AbstractRegistrationDcosAtomicOperationDescription description, Errors errors) {
    def helper = new StandardDcosAttributeValidator("registerDcosAtomicOperationDescription", errors)
