...
@Component
class EnableDcosAtomicOperationValidator extends DescriptionValidator<EnableDisableDcosAtomicOperationDescription> {
  @Autowired
  AccountCredentialsProvider accountCredentialsProvider

  @Override
  void validate(List priorDescriptions, EnableDisableDcosAtomicOperationDescription description, Errors errors) {
    def helper = new StandardDcosAttributeValidator("enableDcosAtomicOperationDescription", errors)
