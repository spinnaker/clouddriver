...
@Component
class ResizeDcosAtomicOperationValidator extends DescriptionValidator<ResizeDcosAtomicOperationDescription> {
  @Autowired
  AccountCredentialsProvider accountCredentialsProvider

  @Override
  void validate(List priorDescriptions, ResizeDcosAtomicOperationDescription description, Errors errors) {
    def helper = new StandardDcosAttributeValidator("resizeDcosAtomicOperationDescription", errors)
