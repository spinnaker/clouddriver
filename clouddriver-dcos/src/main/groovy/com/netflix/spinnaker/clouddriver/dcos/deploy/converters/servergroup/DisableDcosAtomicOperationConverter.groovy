...
import com.netflix.spinnaker.clouddriver.dcos.deploy.ops.servergroup.DisableDcosAtomicOperation
...
@Component
class DisableDcosAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
  AtomicOperation convertOperation(Map input) {
    new DisableDcosAtomicOperation(convertDescription(input))
  }
