...
import com.netflix.spinnaker.clouddriver.dcos.deploy.description.servergroup.DcosContainerDescription
import com.netflix.spinnaker.clouddriver.dcos.deploy.description.servergroup.DcosHandlerType
import com.netflix.spinnaker.clouddriver.dcos.deploy.description.servergroup.DcosProbe

class DcosContainerValidator {
  static void validate(DcosContainerDescription description, StandardDcosAttributeValidator helper, String prefix) {
  ...
  static void validateProbe(DcosProbe probe, StandardDcosAttributeValidator helper, String prefix) {
