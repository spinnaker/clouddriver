    ...
    new App().with {
      ...
      readinessChecks = description.readinessChecks ? description.readinessChecks.collect({ readinessCheck ->
        new ReadinessCheck().with {
          ...
          intervalSeconds = readinessCheck.intervalSeconds ? readinessCheck.intervalSeconds : 0
          timeoutSeconds = readinessCheck.timeoutSeconds ? readinessCheck.timeoutSeconds : 0
