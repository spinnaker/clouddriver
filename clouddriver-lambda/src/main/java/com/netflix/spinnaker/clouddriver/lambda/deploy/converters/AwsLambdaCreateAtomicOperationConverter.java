...
public class AwsLambdaCreateAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
  ...
  @Override
  public CreateLambdaDescription convertDescription(Map input) {
    CreateLambdaDescription converted = getObjectMapper().convertValue(input, CreateLambdaDescription.class);
