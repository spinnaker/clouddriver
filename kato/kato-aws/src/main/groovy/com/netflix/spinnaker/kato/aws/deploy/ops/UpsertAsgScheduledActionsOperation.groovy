    ...
    try {
      ...
      description.scheduledActions.each { action ->
        def request = new PutScheduledUpdateGroupActionRequest()
            ...
            .withScheduledActionName(asgName + '-' + idGenerator.nextId())
        ...
        task.updateStatus BASE_PHASE, "Adding scheduled action ${request.scheduledActionName} - recurrence: ${action.recurrence}, min: ${action.minSize}, max: ${action.maxSize}, desired: ${action.desiredCapacity}"
