...
public class OperationsService {
  ...
  @Nonnull
  public StartOperationResult start(
      @Nonnull List<AtomicOperation> atomicOperations, @Nullable String id) {
    Task task =
                ...
                input.entrySet().stream()
                    .map(
                        e -> {
                          ...
                          Object description = converter.convertDescription(descriptionInput);
  ...
  @Getter
  public static class StartOperationResult {
    @JsonProperty private final String id;

    public StartOperationResult(String id) {
      this.id = id;
    }
