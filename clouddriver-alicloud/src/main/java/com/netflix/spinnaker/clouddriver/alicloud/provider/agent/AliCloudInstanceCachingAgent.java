...
public class AliCloudInstanceCachingAgent implements CachingAgent {
  ...
  public CacheResult loadData(ProviderCache providerCache) {
    ...
    List<CacheData> instanceDatas = instances.stream().map(instance -> {
      ...
      return (CacheData)new DefaultCacheData(
          Keys.getInstanceKey(instance.getInstanceId(), account.getName(), bizRegionId),
          attributes,
          new HashMap<>(16));
