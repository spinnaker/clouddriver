...
public class ApplicationCacheClientTest extends CommonCacheClient {
  ...
  public void shouldConvert() {
    ...
    when(cacheView.get(ECS_APPLICATIONS.toString(), key))
  ...
  public void shouldGetApplication() {
    ...
    when(cacheView.get(eq(ECS_APPLICATIONS.ns), eq(key), any()))
  ...
  public void shouldGetApplications() {
    ...
    when(cacheView.getAll(eq(ECS_APPLICATIONS.ns), any(), any()))
