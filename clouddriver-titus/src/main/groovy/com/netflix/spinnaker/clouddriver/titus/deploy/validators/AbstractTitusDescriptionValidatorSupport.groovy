...
abstract class AbstractTitusDescriptionValidatorSupport<T extends AbstractTitusCredentialsDescription> extends DescriptionValidator<T> {
  ...
  protected void validateRegion(T description, String regionName, String errorKey, Errors errors) {
    validateRegions(description, regionName ? [regionName] : [], errorKey, errors, "region")
  }

  protected void validateRegions(T description,
                                 Collection<String> regionNames,
                                 String errorKey,
                                 Errors errors,
                                 String attributeName = "regions") {
    if (!regionNames) {
  ...
  protected void validateAsgName(T description, Errors errors) {
  ...
  protected void validateAsgNameAndRegionAndInstanceIds(T description, Errors errors) {
