...
class UpsertTitusJobDisruptionBudgetAtomicOperation implements AtomicOperation<Void> {
  ...
  UpsertTitusJobDisruptionBudgetAtomicOperation(TitusClientProvider titusClientProvider,
  ...
  Void operate(List priorOutputs) {
    ...
    task.updateStatus PHASE, "Updating Titus Job Disruption: ${description.jobId}..."

    titusClient.updateDisruptionBudget(new JobDisruptionBudgetUpdateRequest()
        .withJobId(description.jobId)
