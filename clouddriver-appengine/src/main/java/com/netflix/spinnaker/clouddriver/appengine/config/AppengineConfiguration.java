...
public class AppengineConfiguration {
  private static final Logger log = LoggerFactory.getLogger(AppengineConfiguration.class);
            ...
            a -> {
              try {
                ...
                return new AppengineNamedAccountCredentials.Builder()
                    .name(a.getName())
                    .environment(
                        StringUtils.isEmpty(a.getEnvironment()) ? a.getName() : a.getEnvironment())
                    .accountType(
                        StringUtils.isEmpty(a.getAccountType()) ? a.getName() : a.getAccountType())
