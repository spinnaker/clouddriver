...
class OpenstackSubnetProviderSpec extends Specification {
  ...
  void "test get all"() {
    ...
    OpenstackSubnet expected = new OpenstackSubnet(type: OpenstackCloudProvider.ID, account: account, region: region)
    ...
    1 * mockData.id >> subnetKey
    1 * mockData.attributes >> attributes
    1 * objectMapper.convertValue(attributes, NeutronSubnet) >> subnet
