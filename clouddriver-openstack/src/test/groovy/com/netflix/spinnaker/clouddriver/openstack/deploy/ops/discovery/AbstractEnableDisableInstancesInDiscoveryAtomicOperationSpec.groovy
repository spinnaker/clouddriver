...
class AbstractEnableDisableInstancesInDiscoveryAtomicOperationSpec extends Specification {
  ...
  def initDescription(boolean consulEnabled = true) {
    ...
    OpenstackNamedAccountCredentials credz = new OpenstackNamedAccountCredentials("name", "test", "main", "user", "pw", "tenant", "domain", "endpoint", [], false, "", new OpenstackConfigurationProperties.LbaasConfig(pollTimeout: 60, pollInterval: 5), new ConsulConfig(enabled: consulEnabled))
